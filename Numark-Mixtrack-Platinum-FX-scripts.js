...
MixtrackPlatinumFX.trackBPM = function (value, group, control) {
  ...
  MixtrackPlatinumFX.bpms[script.deckFromGroup(group) - 1] = engine.getValue(
    group,
    "bpm",
  );
};
...
MixtrackPlatinumFX.init = function (id, debug) {
  ...
  midi.sendSysexMsg(
    MixtrackPlatinumFX.faderCutSysex4,
    MixtrackPlatinumFX.faderCutSysex4.length,
  );
  ...
  for (i = 0; i < 4; i++) {
    ...
    MixtrackPlatinumFX.updateRateRange(
      i,
      group,
      MixtrackPlatinumFX.pitchRanges[0],
    );
    ...
    engine
      .makeConnection(group, "track_loaded", MixtrackPlatinumFX.trackBPM)
      .trigger();
  }
  for (i = 0; i < 2; i++) {
    MixtrackPlatinumFX.effect[i] = new MixtrackPlatinumFX.EffectUnit(
      (i % 2) + 1,
    );
  }
  ...
  engine
    .makeConnection("[Channel1]", "rate", MixtrackPlatinumFX.rateCallback)
    .trigger();
  engine
    .makeConnection("[Channel2]", "rate", MixtrackPlatinumFX.rateCallback)
    .trigger();
  engine
    .makeConnection("[Channel3]", "rate", MixtrackPlatinumFX.rateCallback)
    .trigger();
  engine
    .makeConnection("[Channel4]", "rate", MixtrackPlatinumFX.rateCallback)
    .trigger();
  ...
  engine.makeConnection(
    ...
    MixtrackPlatinumFX.timeElapsedCallback,
  );
  MixtrackPlatinumFX.initComplete = true;
  MixtrackPlatinumFX.updateArrows(true);

  MixtrackPlatinumFX.BlinkTimer = engine.beginTimer(
    MixtrackPlatinumFX.blinkDelay / 2,
    MixtrackPlatinumFX.BlinkFunc,
  );
};
...
MixtrackPlatinumFX.FxBlinkUpdateLEDs = function () {
  ...
  midi.sendShortMsg(
    ...
    0x00,
    newStates1[0]
      ? MixtrackPlatinumFX.HIGH_LIGHT
      : MixtrackPlatinumFX.LOW_LIGHT,
  );
  midi.sendShortMsg(
    0x98,
    0x01,
...
MixtrackPlatinumFX.FxBlink = function () {
  var start =
    MixtrackPlatinumFX.effect[0].isSwitchHolded ||
    MixtrackPlatinumFX.effect[1].isSwitchHolded;
  ...
  this.bpm = new components.Component({
    ...
    output: function (value, group, control) {
      if (MixtrackPlatinumFX.bpms[script.deckFromGroup(group) - 1] == 0) {
        MixtrackPlatinumFX.bpms[script.deckFromGroup(group) - 1] =
            ...
            if (tapch) {
              ...
              if (value > 0 && MixtrackPlatinumFX.bpms[tapch - 1]) {
                engine.setValue(
                  "[Channel" + tapch + "]",
                  "bpm",
                  MixtrackPlatinumFX.bpms[tapch - 1],
                );
              }
              this.send(this.outValueScale(value));
            }
    ...
    shift: function () {
      this.input = function (channel, control, value) {
        ...
        this.currentRangeIdx =
          (this.currentRangeIdx + 1) % MixtrackPlatinumFX.pitchRanges.length;
        MixtrackPlatinumFX.updateRateRange(
          channel,
          this.group,
          MixtrackPlatinumFX.pitchRanges[this.currentRangeIdx],
        );
      };
    },
    unshift: function () {
...
MixtrackPlatinumFX.PadSection = function (deckNumber) {
  ...
  this.modes = {};
  this.modes[MixtrackPlatinumFX.PadModeControls.HOTCUE] =
    new MixtrackPlatinumFX.ModeHotcue(deckNumber, false);
  this.modes[MixtrackPlatinumFX.PadModeControls.AUTOLOOP] =
    new MixtrackPlatinumFX.ModeAutoLoop(deckNumber, false);
  this.modes[MixtrackPlatinumFX.PadModeControls.FADERCUTS] =
    new MixtrackPlatinumFX.ModeFaderCuts(deckNumber, false);
  this.modes[MixtrackPlatinumFX.PadModeControls.FADERCUTS2] =
    new MixtrackPlatinumFX.ModeFaderCuts(deckNumber, 1);
  this.modes[MixtrackPlatinumFX.PadModeControls.FADERCUTS3] =
    new MixtrackPlatinumFX.ModeFaderCuts(deckNumber, 2);
  this.modes[MixtrackPlatinumFX.PadModeControls.SAMPLE1] =
    new MixtrackPlatinumFX.ModeSample(deckNumber, false);
  this.modes[MixtrackPlatinumFX.PadModeControls.BEATJUMP] =
    new MixtrackPlatinumFX.ModeBeatjump(deckNumber, 2);
  this.modes[MixtrackPlatinumFX.PadModeControls.SAMPLE2] =
    new MixtrackPlatinumFX.ModeSample(deckNumber, 1);
  this.modes[MixtrackPlatinumFX.PadModeControls.AUTOLOOP2] =
    new MixtrackPlatinumFX.ModeAutoLoop(deckNumber, 1);
  this.modes[MixtrackPlatinumFX.PadModeControls.KEYPLAY] =
    new MixtrackPlatinumFX.ModeKeyPlay(deckNumber, 2);
  this.modes[MixtrackPlatinumFX.PadModeControls.HOTCUE2] =
    new MixtrackPlatinumFX.ModeHotcue(deckNumber, 1);
  this.modes[MixtrackPlatinumFX.PadModeControls.AUTOLOOP3] =
    new MixtrackPlatinumFX.ModeCueLoop(deckNumber, 2);
  ...
  this.modeButtonPress = function (channel, control, value) {
    ...
    if (this.longPressTimer !== 0) {
      ...
      if (value == 0x7f) {
        ...
        if (
          control == MixtrackPlatinumFX.PadModeControls.SAMPLE1 &&
        ...
        if (
          control == MixtrackPlatinumFX.PadModeControls.HOTCUE &&
        ...
        if (
          control == MixtrackPlatinumFX.PadModeControls.FADERCUTS &&
        ...
        if (
          control == MixtrackPlatinumFX.PadModeControls.AUTOLOOP &&
  ...
  this.setMode = function (channel, control) {
    var ctrl2 = control;
    if (
      ctrl2 == MixtrackPlatinumFX.PadModeControls.SAMPLE2 &&
      this.currentMode.name == MixtrackPlatinumFX.PadModeControls.KEYPLAY
    ) {
    ...
    if (
      ctrl2 == MixtrackPlatinumFX.PadModeControls.AUTOLOOP &&
      MixtrackPlatinumFX.shifted
    ) {
      ctrl2 = MixtrackPlatinumFX.PadModeControls.AUTOLOOP2;
    }
    if (
      ctrl2 == MixtrackPlatinumFX.PadModeControls.FADERCUTS &&
      MixtrackPlatinumFX.shifted
    ) {
    ...
    if (this.longPressTimer === 0) {
      if (
        ctrl2 == MixtrackPlatinumFX.PadModeControls.SAMPLE1 ||
        ctrl2 == MixtrackPlatinumFX.PadModeControls.HOTCUE ||
        ctrl2 == MixtrackPlatinumFX.PadModeControls.FADERCUTS ||
        ctrl2 == MixtrackPlatinumFX.PadModeControls.AUTOLOOP
      ) {
...
MixtrackPlatinumFX.PadSection.prototype = Object.create(
...
MixtrackPlatinumFX.ModeHotcue.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeAutoLoop.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeCueLoop.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeKeyPlay.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeFaderCuts = function (deckNumber, secondaryMode) {
  ...
  this.activate = function () {
    if (this.secondaryMode == 1) {
      midi.sendSysexMsg(
        MixtrackPlatinumFX.faderCutSysex8,
        MixtrackPlatinumFX.faderCutSysex8.length,
      );
    } else {
      midi.sendSysexMsg(
        MixtrackPlatinumFX.faderCutSysex4,
...
MixtrackPlatinumFX.ModeFaderCuts.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeSample.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.ModeBeatjump.prototype = Object.create(
  components.ComponentContainer.prototype,
);
...
MixtrackPlatinumFX.wheelTouch = function (channel, control, value) {
  ...
  if (
    !MixtrackPlatinumFX.shifted &&
    MixtrackPlatinumFX.deck[channel].scratchModeEnabled &&
    value === 0x7f
  ) {
    // touch start
    ...
    engine.scratchEnable(
      deckNumber,
      MixtrackPlatinumFX.jogScratchSensitivity,
      33 + 1 / 3,
      MixtrackPlatinumFX.jogScratchAlpha,
      MixtrackPlatinumFX.jogScratchBeta,
      true,
    );
  } else if (value === 0) {
    // touch end
...
MixtrackPlatinumFX.wheelTurn = function (
  channel,
  control,
  value,
  status,
  ...
  if (MixtrackPlatinumFX.shifted) {
    ...
    engine.setValue(
      group,
      "playposition",
      oldPos + newValue / MixtrackPlatinumFX.jogSeekSensitivity,
    );
  } else if (
    MixtrackPlatinumFX.deck[channel].scratchModeEnabled &&
    ...
    engine.setValue(
      group,
      "jog",
      newValue / MixtrackPlatinumFX.jogPitchSensitivity,
    );
  }
};
...
MixtrackPlatinumFX.shiftToggle = function (
  channel,
  control,
  value,
  status,
...
MixtrackPlatinumFX.deckSwitch = function (
  channel,
  control,
  value,
  status,
...
MixtrackPlatinumFX.rateCallback = function (rate, group, control) {
  ...
  MixtrackPlatinumFX.sendScreenRateMidi(
    channel + 1,
